...
<body>
    <div class="container-dashboard d-flex flex-column vh-100">
        ...
        <div class="container-fluid h-100">
            <div class="row h-100">
                <nav class="col-md-2 d-none d-md-block bg-light sidebar py-4 border-right border-dark">
                    <div class="sidebar-sticky">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{route('admin.index')}}{{-- {{route('admin.index', ['id'=>Auth::user()-> id])}} --}}">
